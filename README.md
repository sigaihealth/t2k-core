...
- experimental ontology-bound graph functions, bounded read-only execution,
  explicit evidence receipts, independent V2 evaluation, and provider-neutral
  candidate generation with development-case repair;
