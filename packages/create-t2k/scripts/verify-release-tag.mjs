...
const expectedTag = `create-t2k-v${manifest.version}`;
...
console.log(
  `Release tag ${actualTag} matches create-t2k ${manifest.version}, is annotated at ${tagObjectSha}, and peels to mainline commit ${releaseCommit}.`
);
